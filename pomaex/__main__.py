...
from pomaex import __version__
from pomaex.example import hello
...
app = typer.Typer(
    name="pomaex",
    help="Portable Market Exchange {Repository,Scrapper,Format} for Python",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]pomaex[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the pomaex package.",
    ),
):
